...
// #define ENABLE_WIFIMANAGER       //https://github.com/tzapu/WiFiManager
...
void setup(void)
{
    ...
    /*
    * MAX30208 is an optional module,
    * you need to purchase separately to have this function
    * * */
    ...
    * * */
    ...
    findTempSensor = tempSensor.begin(Wire1, MAX30208_SLAVE_ADDRESS);
    if (findTempSensor) {
...
void RTC_Show()
{
    if (targetTime < millis()) {
        ...
        tft.drawCentreString(getVoltage(), 115, 58, 1); // Next size up font 2
        ...
        if (findTempSensor) {
            ...
            if (mask & MAX30208_INT_STATUS_TEMP_RDY) {
                ...
                tft.drawCentreString(String(t) + "*C", 110, 70, 1); // Next size up font 2
